...
final List<MedicineModel> listMedicine = [
  ...
  MedicineModel(
    hinhAnh: AssetHelper.imgBachChi,
    tenVietNam: 'Bạch chỉ ',
  ...
  MedicineModel(
    hinhAnh: AssetHelper.imgBachThuoc,
  ...
  MedicineModel(
    hinhAnh: AssetHelper.imgCauDang,
    tenVietNam: 'Câu đằng',
  ...
  MedicineModel(
    hinhAnh: AssetHelper.imgCamThao,
    tenVietNam: 'Cam thảo',
  ...
  MedicineModel(
    hinhAnh: AssetHelper.imgDoTrong,
    tenVietNam: 'Đỗ Trọng',
    //tenKhoaHoc: ,
    moTa:
  ...
  MedicineModel(
    hinhAnh: AssetHelper.imgHoaiSon,
    tenVietNam: 'Hoài Sơn',
  ...
  MedicineModel(
    hinhAnh: AssetHelper.imgHoangBa,
    tenVietNam: 'Hoàng Bá',
  ...
  MedicineModel(
    hinhAnh: AssetHelper.imgHoangDang,
  ...
  MedicineModel(
    hinhAnh: AssetHelper.imgHoangLien,
  ...
  MedicineModel(
    hinhAnh: AssetHelper.imgLacTien,
    tenVietNam: 'Lạc tiên',
  ...
  MedicineModel(
    hinhAnh: AssetHelper.imgThachXuongBo,
  ...
  MedicineModel(
    hinhAnh: AssetHelper.imgThienNienKien,
  ...
  MedicineModel(
    hinhAnh: AssetHelper.imgCanKhuong,
  ...
  MedicineModel(
    hinhAnh: AssetHelper.imgCatCanh,
    tenVietNam: 'Cát cánh',
  ...
  MedicineModel(
    hinhAnh: AssetHelper.imgCauKyTu,
  ...
  MedicineModel(
    hinhAnh: AssetHelper.imgDangSam,
    tenVietNam: 'Đảng Sâm',
  ...
  MedicineModel(
    hinhAnh: AssetHelper.imgDiaLien,
    tenVietNam: 'Địa liền',
